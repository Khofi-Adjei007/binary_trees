...
/**
* check_sub_tree_Left - Checks if all nodes in the left subtree are smaller
...
/**
* check_sub_tree_Right - Checks if all nodes in the right subtree are bigger
...
* The function verifies if the left subtree has nodes smaller or equal to
* the root and if the right subtree has nodes bigger or equal to the root.
